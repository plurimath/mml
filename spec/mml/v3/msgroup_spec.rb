...
RSpec.describe Mml::V3::Msgroup do
  describe "round-trip" do
    it "parses and serializes stack group" do
      input = '<math xmlns="http://www.w3.org/1998/Math/MathML">' \
              "<mstack><msgroup><msrow><mn>1</mn><mo>+</mo><mn>2</mn></msrow>" \
              "</msgroup></mstack></math>"
    ...
    it "preserves position attribute" do
      input = '<math xmlns="http://www.w3.org/1998/Math/MathML">' \
              '<mstack><msgroup position="1"><msrow><mn>1</mn></msrow></msgroup>' \
              "</mstack></math>"
    ...
    it "preserves shift attribute" do
      input = '<math xmlns="http://www.w3.org/1998/Math/MathML">' \
              '<mstack><msgroup shift="2"><msrow><mn>1</mn></msrow></msgroup>' \
              "</mstack></math>"
      math = Mml.parse(input)
