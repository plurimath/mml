...
RSpec.describe Mml::V3::Mlongdiv do
  describe "round-trip" do
    it "parses and serializes long division element" do
      input = '<math xmlns="http://www.w3.org/1998/Math/MathML">' \
              "<mlongdiv><msgroup><msrow><mn>1</mn><mo>+</mo><mn>2</mn></msrow>" \
              "</msgroup></mlongdiv></math>"
    ...
    it "preserves longdivstyle attribute" do
      input = '<math xmlns="http://www.w3.org/1998/Math/MathML">' \
              '<mlongdiv longdivstyle="right"><msgroup><msrow><mn>1</mn></msrow>' \
              "</msgroup></mlongdiv></math>"
